...
export default function Home() {
  return (
    <div className="relative w-full h-full min-h-dvh">
      <div className="w-full max-w-screen-xl h-full mx-auto px-4 md:px-20 pb-0 md:pb-20 flex flex-col justify-center text-white">
        ...
        <div className="w-full flex flex-col md:flex-row justify-center gap-4 my-4 md:my-10">
          <Link href={"/quiz"} className="w-full md:w-fit flex flex-row gap-6 justify-between items-center uppercase font-sans text-sm font-bold tracking-widest px-8 py-6 rounded bg-teal-800 hover:bg-teal-600 transition duration-300">
